...
| [SDK Failure Resilience Contract](../specs/018-sdk-failure-e2e/contracts/failure-resilience-contract.md) | 실제 loopback HTTP 기반 통신·인증·변수 검증 실패와 application-owned logging 계약 | **실패 복원성 계약** |
...
5. **실제 연동 확인**: [Gemini E2E Example](../examples/gemini-e2e/README.md) & [SDK Failure Resilience Contract](../specs/018-sdk-failure-e2e/contracts/failure-resilience-contract.md)
