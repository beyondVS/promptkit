...
4. Change the selected prompt representation or label mapping. Repeat step 3 and confirm a full 200 response with a different ETag atomically replaces the entry.
