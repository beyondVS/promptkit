...
- [ ] T001 Amend on-live default lookup, published-only labels, `latest`, and `production` prohibition in `.specify/memory/constitution.md`
- [ ] T002 Align branch workflow, documentation scope, and post-implementation audit guidance in `AGENTS.md`
- [ ] T003 [P] Replace rollback/environment/production assumptions with draft-publish-on-live policy in `docs/prompt-server-requirements.md`
- [ ] T004 [P] Replace label, compile-flow, and SDK default-lookup policy in `docs/project-spec.md`
- [ ] T005 [P] Update lifecycle, routing, API boundary, and MVP architecture in `docs/architecture.md`
- [ ] T006 Update only incomplete Day 08+ milestones for lifecycle, labels, SDK lookup, and validation in `docs/project_plan.md`
- [ ] T007 [P] Create the durable SDK read API policy in `docs/sdk-read-api-contract.md`
- [ ] T008 Verify policy consistency across `.specify/memory/constitution.md`, `AGENTS.md`, and `docs/*.md`
